...
class OrderService:
    ...
    async def place_bracket_order(self, order: BracketOrderModel):
        print(f"Starting order placement for {order.symbol}")
        ...
        print("✅ Received order: " + str(order.model_dump()))
        ...
        print("✅ Contract qualified: " + str(contract))
        ...
        print("🔄 Creating parent order: " + str(parent))
        ...
        print("✅ Parent order placed. OrderID: " + str(parent_id))
        ...
        if settings.get("use_take_profit", True):
            ...
            print("✅ Created and placed take profit order: " + str(takeprofit))
        ...
        if settings.get("use_trailing_stop", True):
            ...
            print("✅ Created trailing stop order: " + str(trailing_stop))
